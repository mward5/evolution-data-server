...
Patch0001: 0001-camel-smime-signature-content-description.patch
...
* Tue Aug 25 2026 Mike Ward <mward5@tinfoil-fedora.com> - 3.60.2-3.triplewrap4
- Build the .deb against Ubuntu 26.04 rather than ubuntu:devel, which had
  moved on to a newer GNOME than the target release carries
- Publish a single archive of the packages beside the individual ones
- Stop publishing debug symbols on the release page

* Tue Aug 25 2026 Mike Ward <mward5@tinfoil-fedora.com> - 3.60.2-2.triplewrap3
- Drop the multipart/signed boundary-scan fallback and its test, no longer
  needed now that the composer emits no encoding header on the outer part
- Ship the fork as a single patch of its net difference from 3.60.2

* Fri Aug 21 2026 Mike Ward <mward5@tinfoil-fedora.com> - 3.60.2-1.triplewrap3
- Set a Content-Description on the S/MIME signature part, as the OpenPGP
  code already does

* Fri Aug 21 2026 Mike Ward <mward5@tinfoil-fedora.com> - 3.60.2-1.triplewrap2
- Do not overwrite the stored body when scanning for boundaries
- Require a line end after the boundary delimiter (RFC 2046, Section 5.1.1)
- Add a regression test for the multipart/signed boundary scan

* Sat Jun 06 2026 Mike Ward <mward5@tinfoil-fedora.com> - 3.60.2-1.triplewrap1
- Add multipart/signed parse fallback for triple-wrap S/MIME messages
